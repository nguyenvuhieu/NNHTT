...
const Corpus = () => {
  ...
  const handleCreateGroup = async () => {
    ...
    try {
      ...
      const response = await api.post(`${HOST}/corpus`, newGroup); // Lưu phản hồi từ API
      fetchDocumentGroups(); // Refresh danh sách nhóm tài liệu

      // Cập nhật selectedDocGroup với nhóm mới tạo
  ...
  return (
    <div className="max-w-[1050px] mx-auto my-16 min-h-[800px]">
      <Helmet>
